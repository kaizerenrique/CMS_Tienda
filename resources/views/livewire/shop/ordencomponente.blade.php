<div class="p-6">
    ...
    <h1 class="mb-11 text-center text-2xl font-bold">Generar Orden de Compra</h1>
    ...
    @if ($estado == false)
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600">            
            <div class="p-8 col-span-1 sm:col-span-2 md:col-span-1">
                {{ $perfil->nacionalidad }} - {{ $perfil->cedula }}
            </div>
            <div class="p-8 col-span-1 sm:col-span-2 md:col-span-2">
